...
void SShadowMap::UpdateFromLightDirection(CVector3 lightCameraPos, CVector3 lightDir)
{
...
void SShadowMap::UpdateFromLightTarget(CVector3 lightCameraPos, CVector3 lightCameraTarget)
{
...
void SShadowMap::RenderToShadowMap()
{
